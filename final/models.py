...
class FinalObservation(Observation):
    ...
    reward: float = Field(default=0.01, description="The reward for the current step")
    ...
    task_score: float = Field(default=0.01, description="The current score of the task (strictly 0-1)")
